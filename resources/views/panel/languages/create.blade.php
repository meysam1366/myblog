    ...
    <form action="{{ route('admin.languages.store') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-12 gap-x-4">
            <div class="col-span-full lg:col-span-7 card p-4 lg:p-6">
                <h6 class="card-title">Create New Language</h6>
                <div class="mt-7">
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" id="name" name="name" value="{{ old('name') }}" placeholder="Name" class="form-input" autocomplete="off" required>
                    </div>
                    <div>
                        <label for="lang" class="form-label">Lang *</label>
                        <input type="text" id="lang" name="lang" value="{{ old('lang') }}" placeholder="Lang" class="form-input" autocomplete="off" required>
                    </div>
